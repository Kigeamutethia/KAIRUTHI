            ...
            {[
              {
                ...
                answer: 'You can schedule a consultation by calling us at 0708 209 727, filling out the contact form above, or sending us an email. We typically respond within 24 hours.',
              },
              {
                question: 'What should I bring to the first meeting?',
                answer: 'Please bring any relevant documents related to your case, including contracts, correspondence, court papers, or other materials that may help us understand your situation.',
              },
              {
                question: 'How are your fees structured?',
                answer: 'Our fees vary depending on the nature and complexity of your case. We offer transparent pricing and will discuss our fee structure during your initial consultation.',
              },
              {
                question: 'Do you handle cases outside Nairobi?',
                answer: 'Yes, we handle cases throughout Kenya. Our team is experienced in working with clients across different regions and can accommodate remote consultations when needed.',
              },
              {
                question: 'How long does a typical case take?',
                answer: 'The duration varies greatly depending on the type of case. Some matters can be resolved in weeks, while others may take months or longer. We will provide you with a realistic timeline during our consultation.',
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="bg-white p-6 rounded-lg">
                ...
                <p className="text-black/70">
                  For existing clients with urgent matters outside regular hours, please call our main line and leave a detailed message. A member of our team will respond as quickly as possible.
                </p>
              </div>
            </div>
          </div>
