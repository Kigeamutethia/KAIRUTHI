...
export function About() {
	const values = [
		...
		},
		{
			...
			description:
				"We listen, understand, and tailor our approach to your unique needs.",
		},
		{
			icon: Award,
			title: "Excellence in Legal Practice",
			description:
				"We strive for excellence in every case and client interaction.",
		},
	];
			...
			<section className="relative py-32 bg-[#3d2b1f] text-white">
				<div className="max-w-[1400px] mx-auto px-6">
					...
					<motion.p
						...
						A trusted legal practice offering comprehensive services across
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
						<motion.div
							...
							<p className="text-lg mb-6 leading-relaxed">
								Kairuthi & Co. Advocates is a trusted legal practice offering
								comprehensive legal services across multiple areas of law. Our
								firm was founded on the belief that quality legal representation
								should be accessible, reliable, and results-driven.
							</p>
							<p className="text-lg leading-relaxed">
								We take pride in understanding our clients' unique needs and
								delivering solutions that align with their personal, business,
				...
				<div className="max-w-[1400px] mx-auto px-6">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-xl leading-relaxed mb-8">
							We combine legal knowledge with practical strategy, ensuring clear
							advice, strong advocacy, and effective solutions.
						</p>
						<p className="text-lg text-black/70 leading-relaxed">
							Our team works collaboratively with clients to develop strategies
							that not only address immediate legal concerns but also support
							long-term goals. We believe that the best outcomes come from a
							deep understanding of both the law and our clients' objectives.
						</p>
					</div>
				</div>
			</section>
				...
				<div className="max-w-[1400px] mx-auto px-6">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-black/70 max-w-2xl mx-auto">
							Experienced advocates committed to delivering exceptional legal
							representation
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						{[
							...
							<motion.div
								...
								<h3 className="text-xl mb-2 text-[#2B2B2B] text-center">
									{member.name}
								</h3>
								<p className="text-[#6B4F3A] mb-4 text-center">
									{member.specialty}
								</p>
							...
							<div className="space-y-6">
								{[
									...
									<motion.div
										...
										<div>
											<h3 className="text-xl mb-2 text-[#2B2B2B]">
												{item.title}
											</h3>
			...
			<section className="py-24 bg-[#F5EFE6]">
				<div className="max-w-[1400px] mx-auto px-6">
					<div className="max-w-4xl mx-auto">
						<h2 className="text-4xl text-center mb-12 text-[#2B2B2B]">
							Our Commitment to Excellence
						</h2>
						<div className="space-y-8">
							<div>
								...
								<p className="text-lg text-black/70 leading-relaxed">
									The legal landscape is constantly evolving. Our team stays
									current with the latest developments in law, ensuring we
									provide the most relevant and effective advice to our clients.
								</p>
							</div>
							<div>
								<h3 className="text-2xl mb-4 text-[#2B2B2B]">
								...
								<p className="text-lg text-black/70 leading-relaxed">
									We leverage modern technology to enhance our services,
									streamline processes, and provide clients with efficient,
							...
							<div>
								...
								<p className="text-lg text-black/70 leading-relaxed">
									Beyond our practice, we are committed to giving back to the
									community through pro bono work, legal education initiatives,
